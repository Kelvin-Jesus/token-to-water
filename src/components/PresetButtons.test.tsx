...
describe('PresetButtons', () => {
  it('offers the five presets with their token counts', () => {
    ...
    expect(screen.getByRole('button', { name: /Building this app\s*1\d\dM tokens\s*Every token Claude processed/ })).toBeInTheDocument()
  })
